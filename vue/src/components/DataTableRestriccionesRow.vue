<template>
  <tr @click="visualizar">
    ...
    <td> <input  @keyup="verificarCambio({name:'desActividad', value: restriction_row.desActividad})" v-model="restriction_row.desActividad" type="text" class="w-full border border-[#8A9CC9] px-2 h-10 rounded" :class="{'bg-gray-100': !statusRestriction , 'text-gray-700': !statusRestriction  }" /> </td>
    <td> <input  @keyup="verificarCambio({name:'desRestriccion', value: restriction_row.desRestriccion})" v-model="restriction_row.desRestriccion" type="text" class="w-full border border-[#8A9CC9] px-2 h-10 rounded"  :class="{'bg-gray-100': !statusRestriction , 'text-gray-700': !statusRestriction  }" /> </td>
    <td>
      <div v-if="statusRestriction" class="flex relative  cursor-pointer cursor-pointer">
        ...
        <input  v-model="restriction_row.desTipoRestriccion" type="text" class="w-full border border-[#8A9CC9] px-2 h-10 rounded "  placeholder="Elegir Tipo Restricción" :class="{'bg-gray-100': !statusRestriction , 'text-gray-700': !statusRestriction  }" />
